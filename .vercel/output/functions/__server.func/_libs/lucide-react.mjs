...
const CircleMinus = createLucideIcon("circle-minus", __iconNode$F);
const __iconNode$E = [
  ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
...
const IndianRupee = createLucideIcon("indian-rupee", __iconNode$x);
const __iconNode$w = [
  [
    "path",
    {
...
const MailOpen = createLucideIcon("mail-open", __iconNode$t);
const __iconNode$s = [
...
const MessageSquareText = createLucideIcon("message-square-text", __iconNode$p);
const __iconNode$o = [
  [
    "path",
    {
...
const Percent = createLucideIcon("percent", __iconNode$k);
const __iconNode$j = [
  ["path", { d: "M5 12h14", key: "1ays0h" }],
